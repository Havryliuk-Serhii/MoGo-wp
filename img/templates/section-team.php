...
<section class="team">
	<div class="container">
		...
		<?php if ($team_mate->have_posts() ) : 
			...
			<div class="col-md-4 col-12 team-item">
				<div class="card photo">
	            	...
	            	<div class="photo-social-links">
	                	<div class="social-link">
		                    <a href="<?php echo get_option('fb-link'); ?>">
		                       	<i class="fab fa-facebook-f"></i>
		                    </a>
		            	    <a href="<?php echo get_option('tw-link'); ?>">
		                        <i class="fab fa-twitter"></i>
		                    </a>
		                    <a href="<?php echo get_option('pin-link'); ?>">
		                        <i class="fab fa-pinterest-p"></i>
		                    </a>
		                    <a href="<?php echo get_option('in-link'); ?>">
